...
use Dhii\Espresso\Expression\XorExpression;
use Dhii\Evaluable\EvaluableInterface;
use Xpmock\TestCase;

/**
 * Tests {@see Dhii\Espresso\Expression\ XorExpression}.
 *
 * @since 0.1
 */
class XorExpressionTest extends TestCase
{
    /**
